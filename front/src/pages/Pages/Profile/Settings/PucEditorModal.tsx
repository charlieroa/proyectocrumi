...
import {
  Button, Input, Modal, ModalBody, ModalFooter, ModalHeader, Spinner, Table, Badge
} from 'reactstrap';
...
const emptyForm: Partial<Account> = { account_code: '', account_name: '', account_type: '', parent_code: null, level: 1, is_active: true };

const PucEditorModal: React.FC<Props> = ({ isOpen, onClose }) => {
  ...
  return (
    <Modal isOpen={isOpen} toggle={onClose} size="xl" scrollable>
      <ModalHeader toggle={onClose}>
        <i className="ri-book-2-line me-2" />Plan de cuentas (PUC)
      </ModalHeader>
      <ModalBody>
        <div className="d-flex flex-wrap gap-2 align-items-center mb-3">
          ...
          <div className="form-check form-switch ms-2">
            <Input type="checkbox" className="form-check-input" id="puc-show-inactive" checked={showInactive} onChange={e => setShowInactive(e.target.checked)} />
            ...
            <div className="row g-2">
              ...
              <div className="col-md-2 d-flex align-items-end">
                <div className="form-check form-switch">
                  <Input type="checkbox" className="form-check-input" id="puc-active" checked={editing.is_active !== false} onChange={e => setEditing(prev => ({ ...prev!, is_active: e.target.checked }))} />
