...
const TercerosHubLayout: React.FC<Props> = ({ title, subtitle, icon, iconColor = 'primary', actions, hideBack, children }) => {
    ...
    <Container fluid className="py-3">
      <div className="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
        <div className="d-flex align-items-center gap-3">
          {!hideBack && (
            <Button color="light" size="sm" onClick={() => navigate('/terceros-hub')} title="Volver">
...
export default TercerosHubLayout;
