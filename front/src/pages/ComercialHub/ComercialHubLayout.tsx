...
const ComercialHubLayout: React.FC<Props> = ({ title, subtitle, icon, iconColor = 'primary', actions, children }) => {
  const navigate = useNavigate();
  return (
    <Container fluid className="py-3">
      <div className="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
        <div className="d-flex align-items-center gap-3">
          <Button color="light" onClick={() => navigate('/comercial-hub')} title="Volver al hub">
...
export default ComercialHubLayout;
