...
(async () => {
    console.log("🚀 Enviando UNA factura de prueba con fecha HOY...");

    const num = 'SETP990011001';
    const client = { name: 'CONSUMIDOR FINAL', idNumber: '222222222222', docType: '13', dv: '2' };
    const items = [{ description: 'Test HOY', quantity: 1, unitPrice: 1000, lineTotal: 1000, lineBase: 1000, tax: 19, taxVal: 190, code: 'T1' }];
    ...
    console.log(`📄 Factura: ${num} | Fecha: ${TODAY}`);
