...
// GET /api/users/contadores - Listado de contadores (rol 4). Solo Super Admin.
router.get('/contadores', authMiddleware, userController.getContadores);

// GET /api/users/all - Listado de todos los usuarios. Solo Super Admin.
router.get('/all', authMiddleware, userController.getAllUsersForSuperAdmin);
