...
@XmlRootElement(name = "GetAcquirer")
public class GetAcquirer {

    @XmlElementRef(name = "identificationType", namespace = "http://wcf.dian.colombia", type = JAXBElement.class, required = false)
    protected JAXBElement<String> identificationType;
    @XmlElementRef(name = "identificationNumber", namespace = "http://wcf.dian.colombia", type = JAXBElement.class, required = false)
     ...
     *     
     */
    public JAXBElement<String> getIdentificationType() {
     ...
     *     
     */
    public void setIdentificationType(JAXBElement<String> value) {
